    ...
    def define_model(self,
        ...
        if build_architecture:
            ...
            lstm =       TKL.LSTM(
                ...
                name='lstm1', 
                bias_regularizer=regularizers.l1_l2(l1=0.0001, l2=0.0001)
                )(conv)
            lstm = TKL.Dropout(dropout_rate)(lstm)
            output_layer = TKL.Dense(
                n_features_out, 
                activation=activation, 
                name='dense1',
                )(lstm)
        ...
        self.logger.info('CNN-LSTM-BNN_24 model v1'.ljust(self.justif-10,'.') + 'CONFIGURED')
        return
