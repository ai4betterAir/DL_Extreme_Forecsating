...
from ..Tools import CustomLosses as CL
...
###########################################################################################
    def define_model(self,
        ...
        if build_architecture:
            ...
            self.model = BM.Model([input_layer], [output_layer], name=self.KERAS_NORMALISATION_MODEL_NAME)
            ...
            loss_function = CL.CustomLosses()
            # loss_function = BM.custom_loss_function
