...
# Default region selection lives in Core_iHPC/main.py.
...
# Run mode defaults
DEFAULT_TRAIN_MODEL = True  # Set to True only when you want to train; forecast/dashboard runs default to False.
DEFAULT_PLOT = True
