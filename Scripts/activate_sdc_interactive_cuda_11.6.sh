...
modules_dir=/mnt/appsource/local/CAS/software/anaconda3/Environments/deep_learning_tensorflow_gpu_cuda_11.6/init_scripts/modules
...
conda activate /mnt/appsource/local/CAS/software/anaconda3/Environments/deep_learning_tensorflow_gpu_cuda_11.6
module load slurm
